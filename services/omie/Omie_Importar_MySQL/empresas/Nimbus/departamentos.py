...
def etl_departamentos_nimbus():
    api = OmieAPI()
    print('Iniciando ETL de departamentos Nimbus...')
    parametros = {
        'pagina': 1,
    ...
    tabela = f"departamentos_{empresa_nome.lower()}"
    salvar_com_fallback(df, tabela)
    print('ETL de departamentos finalizado.')

if __name__ == '__main__':
    etl_departamentos_nimbus()
