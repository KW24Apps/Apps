...
class LogHelper
{
    ...
    // Registra uma mensagem de log específica para Deals
    public static function logDeal(string $mensagem, string $contexto = ''): void
    {
        $arquivoLog = __DIR__ . '/../../logs/deal_debug.log';
        $timestamp = date('Y-m-d H:i:s');
        $traceId = defined('TRACE_ID') ? TRACE_ID : 'sem_trace';
        $aplicacao = defined('NOME_APLICACAO') ? NOME_APLICACAO : 'desconhecida';
    ...
    /**
     * Registra logs específicos do processo de Gerar Oportunidades
     */
    public static function logGerarOportunidade(string $mensagem, string $contexto = ''): void
    {
        $arquivoLog = __DIR__ . '/../../logs/gerar_oportunidade.log';
        $timestamp = date('Y-m-d H:i:s');
        $traceId = defined('TRACE_ID') ? TRACE_ID : 'sem_trace';
        $aplicacao = defined('NOME_APLICACAO') ? NOME_APLICACAO : 'desconhecida';
    ...
    // Registra uma mensagem de log para o módulo Disk
    public static function logDisk(string $mensagem, string $contexto = ''): void
    {
        $arquivoLog = __DIR__ . '/../../logs/disk.log';
        $timestamp = date('Y-m-d H:i:s');
        $traceId = defined('TRACE_ID') ? TRACE_ID : 'sem_trace';
        $aplicacao = defined('NOME_APLICACAO') ? NOME_APLICACAO : 'desconhecida';
    ...
    /**
     * Registra logs específicos para o serviço da Receita Federal
     */
    public static function logReceitaFederal(string $mensagem, string $contexto = ''): void
    {
        $arquivoLog = __DIR__ . '/../../logs/receita_federal.log';
        $timestamp = date('Y-m-d H:i:s');
        $traceId = defined('TRACE_ID') ? TRACE_ID : 'sem_trace';
        $aplicacao = defined('NOME_APLICACAO') ? NOME_APLICACAO : 'desconhecida';
    ...
    /**
     * Registra logs específicos para o serviço de Publicações Online
     */
    public static function logPublicacoes(string $mensagem, string $contexto = ''): void
    {
        $arquivoLog = __DIR__ . '/../../logs/publicacoes.log';
        $timestamp = date('Y-m-d H:i:s');
        $traceId = defined('TRACE_ID') ? TRACE_ID : 'sem_trace';
        $aplicacao = defined('NOME_APLICACAO') ? NOME_APLICACAO : 'desconhecida';
