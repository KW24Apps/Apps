...
class BitrixInController
{
    ...
    {
        // Verificação de parâmetro obrigatório
        ...
        // Sincronização dos contatos vinculados
        $camposContatos = [
            'UF_CRM_1684436968',
            'UF_CRM_1695306238',
            'UF_CRM_1733848071'
        ...
        // Sincronização das aplicações e webhooks
        $aplicacoes = [
